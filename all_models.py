...
def logistic_regression():
    ...
    # Losses
    loss_model = SGDClassifier(loss='log', learning_rate='constant', eta0=0.01, max_iter=1, warm_start=True, penalty=None)
    losses = []
    ...
    print(f'Accuracy of the Logistic Regression Model: {accuracy_score(y_test_raw, y_pred):.4f}')
